...
inline std::error_code make_error_code(MevaCoin::error::BlockchainExplorerErrorCodes e) {
  return std::error_code(static_cast<int>(e), MevaCoin::error::BlockchainExplorerErrorCategory::INSTANCE);
}
