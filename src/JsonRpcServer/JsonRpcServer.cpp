...
void JsonRpcServer::makeErrorResponse(const std::error_code& ec, Common::JsonValue& resp) {
  ...
  JsonValue code;
  code = static_cast<int64_t>(MevaCoin::JsonRpc::errParseError); //Application specific error code
...
void JsonRpcServer::makeMethodNotFoundResponse(Common::JsonValue& resp) {
  ...
  JsonValue code;
  code = static_cast<int64_t>(MevaCoin::JsonRpc::errMethodNotFound); //ambigous declaration of JsonValue::operator= (between int and JsonValue)
...
void JsonRpcServer::makeJsonParsingErrorResponse(Common::JsonValue& resp) {
  ...
  JsonValue error(JsonValue::OBJECT);
  JsonValue code;
  code = static_cast<int64_t>(MevaCoin::JsonRpc::errParseError); //ambigous declaration of JsonValue::operator= (between int and JsonValue)
