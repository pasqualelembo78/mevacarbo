...
public:
  ...
  size_t mevacoinCoinVersion() const { return m_mevacoinCoinVersion; }
  ...
  size_t difficultyBlocksCount2() const { return MevaCoin::parameters::DIFFICULTY_WINDOW_V2; }
  size_t difficultyBlocksCount3() const { return MevaCoin::parameters::DIFFICULTY_WINDOW_V3; }
  size_t difficultyBlocksCount4() const { return MevaCoin::parameters::DIFFICULTY_WINDOW_V4; }
  ...
  bool getBlockReward(uint8_t blockMajorVersion, uint32_t height, size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins,
...
public:
  ...
  CurrencyBuilder& mevacoinCoinVersion(size_t val) { m_currency.m_mevacoinCoinVersion = val; return *this; }
