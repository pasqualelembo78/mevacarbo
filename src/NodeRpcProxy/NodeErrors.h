...
inline std::error_code make_error_code(MevaCoin::error::NodeErrorCodes e) {
  return std::error_code(static_cast<int>(e), MevaCoin::error::NodeErrorCategory::INSTANCE);
}
