...
namespace MevaCoin
{
  ...
  struct P2pConnectionContext : public MevaCoinConnectionContext {
  public:
  ...
  public:
    ...
    NodeServer(System::Dispatcher& dispatcher, MevaCoin::MevaCoinProtocolHandler& payload_handler, Logging::ILogger& log);
    ...
    MevaCoin::MevaCoinProtocolHandler& get_payload_object();
    ...
    MevaCoin::PeerlistManager& getPeerlistManager() { return m_peerlist; }
  ...
  private:
    ...
    bool invoke_notify_to_peer(int command, const BinaryArray &req_buff, const MevaCoinConnectionContext &context) override;
    void drop_connection(MevaCoinConnectionContext &context, bool add_fail) override;
    void for_each_connection(const std::function<void(MevaCoin::MevaCoinConnectionContext &, PeerIdType)> &f) override;
    ...
    bool handle_remote_peerlist(const std::vector<PeerlistEntry>& peerlist, time_t local_time, const MevaCoinConnectionContext& context);
    ...
    MevaCoinProtocolHandler& m_payload_handler;
    ...
    boost::uuids::uuid m_network_id = MEVACOIN_NETWORK;
