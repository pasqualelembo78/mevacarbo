...
public:
  RpcServer(
    ...
    Core& core,
    NodeServer& p2p,
    IMevaCoinProtocolQuery& protocolQuery
  );
...
private:
  ...
  MevaCoin::NodeServer& m_p2p;
  MevaCoin::BlockchainExplorerDataBuilder blockchainExplorerDataBuilder;
  const IMevaCoinProtocolQuery& m_protocolQuery;
  ...
  MevaCoin::AccountPublicAddress m_fee_acc;
