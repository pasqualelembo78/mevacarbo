...
struct WalletRecord {
  ...
  MevaCoin::ITransfersContainer* container = nullptr;
...
typedef boost::multi_index_container <
  ...
  boost::multi_index::indexed_by <
    ...
    boost::multi_index::hashed_unique < boost::multi_index::tag <TransfersContainerIndex>,
      BOOST_MULTI_INDEX_MEMBER(WalletRecord, MevaCoin::ITransfersContainer*, container) >
  >
> WalletsContainer;

struct UnlockTransactionJob {
  uint32_t blockHeight;
  MevaCoin::ITransfersContainer* container;
...
typedef boost::multi_index_container <
  MevaCoin::WalletTransaction,
  boost::multi_index::indexed_by <
    boost::multi_index::random_access < boost::multi_index::tag <RandomAccessIndex> >,
    boost::multi_index::hashed_unique < boost::multi_index::tag <TransactionIndex>,
      boost::multi_index::member<MevaCoin::WalletTransaction, Crypto::Hash, &MevaCoin::WalletTransaction::hash >
    >,
    boost::multi_index::ordered_non_unique < boost::multi_index::tag <BlockHeightIndex>,
      boost::multi_index::member<MevaCoin::WalletTransaction, uint32_t, &MevaCoin::WalletTransaction::blockHeight >
    >
  >
> WalletTransactions;

typedef Common::FileMappedVector<EncryptedWalletRecord> ContainerStorage;
typedef std::pair<size_t, MevaCoin::WalletTransfer> TransactionTransferPair;
typedef std::vector<TransactionTransferPair> WalletTransfers;
typedef std::map<size_t, MevaCoin::Transaction> UncommitedTransactions;
