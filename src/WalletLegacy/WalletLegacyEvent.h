...
public:
  ...
  virtual void notify(Tools::ObserverManager<MevaCoin::IWalletLegacyObserver>& observer) = 0;
};
...
public:
  ...
  virtual void notify(Tools::ObserverManager<MevaCoin::IWalletLegacyObserver>& observer) override
  {
