...
#define GENERATE_AND_PLAY_EX_2VER(TestCase) \
  GENERATE_AND_PLAY_EX(TestCase(MevaCoin::BLOCK_MAJOR_VERSION_1)) \
  GENERATE_AND_PLAY_EX(TestCase(MevaCoin::BLOCK_MAJOR_VERSION_2))
    ...
    //GENERATE_AND_PLAY(gen_ring_signature_big); // Takes up to XXX hours (if MEVACOIN_MINED_MONEY_UNLOCK_WINDOW == 10)

    //// Block verification tests
    GENERATE_AND_PLAY_EX_2VER(TestBlockMajorVersionAccepted);
    GENERATE_AND_PLAY_EX(TestBlockMajorVersionRejected(MevaCoin::BLOCK_MAJOR_VERSION_1, MevaCoin::BLOCK_MAJOR_VERSION_2));
    GENERATE_AND_PLAY_EX(TestBlockMajorVersionRejected(MevaCoin::BLOCK_MAJOR_VERSION_2, MevaCoin::BLOCK_MAJOR_VERSION_1));
    GENERATE_AND_PLAY_EX(TestBlockMajorVersionRejected(MevaCoin::BLOCK_MAJOR_VERSION_2, MevaCoin::BLOCK_MAJOR_VERSION_2 + 1));
    ...
    //GENERATE_AND_PLAY_EX_2VER(gen_block_invalid_binary_format); // Takes up to 30 minutes, if MEVACOIN_MINED_MONEY_UNLOCK_WINDOW == 10
