...
public:
  ...
  MultiVersionTest(const MevaCoin::Currency& currency, System::Dispatcher& d, const Tests::Common::BaseFunctionalTestsConfig& config, Logging::ILogger& log) :
  ...
  void run() {
    ...
    MevaCoin::AccountBase stashAddress;
