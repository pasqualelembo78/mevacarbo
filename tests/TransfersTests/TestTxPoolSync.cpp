...
namespace {
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterANodeIsConnectedToAnotherIfTheirBlockchainsAreSynchronized) {
    ...
    std::unique_ptr<MevaCoin::INode> node0;
    std::unique_ptr<MevaCoin::INode> node1;
    std::unique_ptr<MevaCoin::INode> node2;
    std::unique_ptr<MevaCoin::INode> node3;
    ...
    std::vector<std::unique_ptr<MevaCoin::ITransactionReader>> poolTxs1;
    std::vector<std::unique_ptr<MevaCoin::ITransactionReader>> poolTxs2;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterTimedBlockchainsSynchronization) {
    ...
    std::unique_ptr<MevaCoin::INode> node2;
    std::unique_ptr<MevaCoin::INode> node3;
    std::unique_ptr<MevaCoin::INode> node4;
    ...
    std::vector<std::unique_ptr<MevaCoin::ITransactionReader>> poolTxs2;
    std::vector<std::unique_ptr<MevaCoin::ITransactionReader>> poolTxs3;
    std::vector<std::unique_ptr<MevaCoin::ITransactionReader>> poolTxs4;
